...
import mick.studio.donationx.databinding.ActivityDoanteBinding
import mick.studio.donationx.main.DonationXApp
import mick.studio.donationx.models.DonationModel
import timber.log.Timber

class Donate : AppCompatActivity() {
    private lateinit var donateLayout : ActivityDoanteBinding
    lateinit var app: DonationXApp
    var totalDonated = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        donateLayout = ActivityDoanteBinding.inflate(layoutInflater)
